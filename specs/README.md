...
- `003-sensor.md`: script Python para publicar medições simuladas via MQTT.
- `004-mobile-application.md`: aplicativo Flutter com dark mode, cards de sensores, detalhes, gráficos e cadastros.
- `005-ingestor.md`: aplicação Java para consumir MQTT e persistir medições no PostgreSQL.
